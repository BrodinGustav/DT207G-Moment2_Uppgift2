...
Detta görs genom att använda funktionen getData, som hämtar data från en angiven URL och renderar den på sidan.
...
Innan data skickas valideras formulärfälten för att säkerställa att viktig information som företagsnamn, arbetsroll och plats anges. 
...
Detta görs genom att anropa funktionen deleteWork, som skickar en DELETE-förfrågan till databasen med det unika ID:et för erfarenheten som ska tas bort.
